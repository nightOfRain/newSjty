...
var _flowTimeline = _interopRequireDefault(__webpack_require__(/*! ./pages/undo/flow-timeline.vue */ 44));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
/* harmony import */ var _flow_timeline_vue_vue_type_template_id_70833dce___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./flow-timeline.vue?vue&type=template&id=70833dce& */ 45);
/* harmony import */ var _flow_timeline_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./flow-timeline.vue?vue&type=script&lang=js& */ 47);
...
/* harmony import */ var _flow_timeline_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./flow-timeline.vue?vue&type=style&index=0&lang=css& */ 49);
...
//
//
var _default = { data: function data() {return { fileNo: '', fqr: '', createDate: '', deptName: '', dept: '', title: '', note: '', fileFlow: ['发起', '处理中', '完成'], list: [] };}, onLoad: function onLoad(options) {var _this = this;console.log("options.item:" + JSON.stringify(options));var data = {};data.fileNo = options.fileNo;console.log("currPage:" + JSON.stringify(this.currPage));this.commRequest('/app/getFileInfo', data, function (res) {_this.fileNo = res.fileNo;_this.fqr = res.fqr;_this.createDate = res.createDate;_this.type = res.type;_this.deptName = res.deptName;_this.dept = res.dept;_this.title = res.title;_this.note = res.note;_this.flow = res.flow;_this.list = res.list;});}, methods: { BasicsSteps: function BasicsSteps() {this.basics = this.basics == this.basicsList.length - 1 ? 0 : this.basics + 1;}, NumSteps: function NumSteps() {this.num = this.num == this.numList.length - 1 ? 0 : this.num + 1;}, ScrollSteps: function ScrollSteps() {this.scroll = this.scroll == 9 ? 0 : this.scroll + 1;}, queryNote: function queryNote(e) {console.log("queryNote:" + JSON.stringify(e));var _this = this;var flowno = e.currentTarget.dataset.flowno;var vno = e.currentTarget.dataset.vno;uni.navigateTo({ url: '/pages/undo/flow_notes/flow_notes?fileNo=' + _this.fileNo + '&flowNo=' + flowno + '&vno=' + vno });}, textareaAInput: function textareaAInput(e) {this.textareaAValue = e.detail.value;} } };exports.default = _default;
