...
var _App = _interopRequireDefault(__webpack_require__(/*! ./App */ 5));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function ownKeys(object, enumerableOnly) {var keys = Object.keys(object);if (Object.getOwnPropertySymbols) {var symbols = Object.getOwnPropertySymbols(object);if (enumerableOnly) symbols = symbols.filter(function (sym) {return Object.getOwnPropertyDescriptor(object, sym).enumerable;});keys.push.apply(keys, symbols);}return keys;}function _objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i] != null ? arguments[i] : {};if (i % 2) {ownKeys(Object(source), true).forEach(function (key) {_defineProperty(target, key, source[key]);});} else if (Object.getOwnPropertyDescriptors) {Object.defineProperties(target, Object.getOwnPropertyDescriptors(source));} else {ownKeys(Object(source)).forEach(function (key) {Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));});}}return target;}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}var home = function home() {Promise.all(/*! require.ensure | pages/home/home */[__webpack_require__.e("common/vendor"), __webpack_require__.e("pages/home/home")]).then((function () {return resolve(__webpack_require__(/*! ./pages/home/home.vue */ 159));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};



_vue.default.component('home', home);var undo = function undo() {Promise.all(/*! require.ensure | pages/zhlb/index */[__webpack_require__.e("common/vendor"), __webpack_require__.e("pages/zhlb/index")]).then((function () {return resolve(__webpack_require__(/*! ./pages/zhlb/index.vue */ 166));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};


_vue.default.component('undo', undo);var news = function news() {Promise.all(/*! require.ensure | pages/undo/home */[__webpack_require__.e("common/vendor"), __webpack_require__.e("common/main")]).then((function () {return resolve(__webpack_require__(/*! ./pages/undo/home.vue */ 173));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};


_vue.default.component('news', news);var me = function me() {Promise.all(/*! require.ensure | pages/me/home */[__webpack_require__.e("common/vendor"), __webpack_require__.e("pages/me/home")]).then((function () {return resolve(__webpack_require__(/*! ./pages/me/home.vue */ 178));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};


_vue.default.component('me', me);var HMPersonalCenter = function HMPersonalCenter() {Promise.all(/*! require.ensure | pages/me/home */[__webpack_require__.e("common/vendor"), __webpack_require__.e("pages/me/home")]).then((function () {return resolve(__webpack_require__(/*! ./pages/me/home.vue */ 178));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};
...
/* harmony import */ var _home_vue_vue_type_template_id_1a6c0a01___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./home.vue?vue&type=template&id=1a6c0a01& */ 174);
...
//
//
var _default = { data: function data() {return { undoList: [], list: [[], [], [], []], undos: [0, 0, 0, 0], currPage: [0, 0, 0, 0], isZhongjie: false, loginUserId: '', loginStat: true, TabCur: 0, Tab: ['我发起', '我经办', '处理中', '已完成'], showMore: [false, false, false, false] };}, mounted: function mounted() {var _this = this; // var userInfo = uni.getStorageSync("userInfo");
    ...
    // }
    // //页面间通讯监听
    uni.$on('update', this.updated);this.getData();uni.startPullDownRefresh();}, onPullDownRefresh: function onPullDownRefresh() {console.log('refresh');this.currPage[this.TabCur] = 0;this.getData();setTimeout(function () {uni.stopPullDownRefresh();}, 1000);}, methods: { updated: function updated(e) {this.getData();}, InputFocus: function InputFocus(e) {this.InputBottom = e.detail.height;}, InputBlur: function InputBlur(e) {this.InputBottom = 0;}, doBySlef: function doBySlef(e) {var _this = this;var index = e.currentTarget.dataset.index; //判断是自己是否处理人
      ...
      if (this.currPage[this.TabCur] == 0) {this.getData();} else {this.undoList = this.list[this.TabCur];}}, getData: function getData() {var _this = this;var data = {};data.userId = _this.userId;data.flag = this.TabCur;data.pages = this.currPage[this.TabCur]++;data.number = 20;console.log("currPage:" + JSON.stringify(this.currPage));this.commRequest('/app/getUndoList', data, function (res) {console.log("res: " + JSON.stringify(res));if (_this.currPage[_this.TabCur] == 1) {_this.undoList = res.list;_this.list[_this.TabCur] = res.list;} else {
